    ...
    return (
        <main className="bg-white text-black">
            ...
            <section className="h-screen flex items-center justify-center text-center">
                <div>
                    <h1 className="text-[10vw] font-bold">SP AUDIO</h1>
            ...
            >
                <div>
                    <h2 className="text-5xl font-bold">Designed for Music</h2>
            ...
            {/* HORIZONTAL SHOWCASE */}
            <section ref={horizontal} className="h-screen flex items-center">
            ...
            <section className="py-40 text-center bg-gray-100">
                <h2 className="text-6xl font-bold">Feel The Sound</h2>
            ...
            <section className="py-40 bg-black text-white text-center">
                <h2 className="text-6xl font-bold">Start Your Sound Journey</h2>
